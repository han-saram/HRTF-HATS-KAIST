...
% for azim = R_azim
    ...
    eval(['writetable(T,''..\00_Data\PN_HATS\HRTF_cues_az\a' num2str(azim) '.txt'',''Delimiter'',''\t'',''WriteRowNames'',true);'])
    ...
    set(gca,'FontName','times','FontSize',18);
    title(['Spectral cues of left ear at \theta=',num2str(azim),'\circ'],'FontSize',18)
    xlabel('Frequency, kHz','FontSize',18)
