...
%-------------------------------------------------------------------------
%	Title : raw HATS HRTF database generation
%   Synopsis : store raw HATS HRIR data in two columns of text file
...
% root of directory
root_hrtf = '../00_Data/HRTF_HATS_Raw';
root_hats = '../00_Data/TF_HATS';
root_ref5 = '../00_Data/TF_Ref/Mic-R_5dir';

% azimuth angles (0 ~ 355 deg)
for azim = 0:5:355
    fprintf('generating raw HATS HRTF database at %d deg azimuth...\n',azim);
